...
public class Controller4F {
    ...
    public static void main(String[] args) {
        ...
        pn.PetriNetName = "Controller 4 Phase";
        pn.SetName("Controller 4 Phase");
        pn.NetworkPort = 1081;
        ...
        Condition T8Ct2 = new Condition(t8, "in4", TransitionCondition.NotNull);
        ...
        Condition T8Ct4 = new Condition(t8, "in4", TransitionCondition.IsNull);
        ...
        System.out.println("Controller 4 Phase started \n ------------------------------");
        pn.Delay = 2000;
        // pn.Start();
